...
nohup ./sim_pipe_slurm.sh -t -s 'mwa_galaxy_compressed_2' -f  obsid_list_files/MWA128GalaxyTransit -m 50G -w 03:30:00 -v 'sim_mwa_diffuse_low-prec'  > nohup_mwa_diffuse.out &
