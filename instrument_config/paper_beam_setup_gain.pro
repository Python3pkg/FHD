...
CASE beam_model_version OF
    2: BEGIN
        ...
        FOR pol_i=0,n_ant_pol-1 DO BEGIN
            ...
            apply_astrometry, ra_arr=xvals_use, dec_arr=yvals_use, x_arr=x_int, y_arr=y_int, JDate=obs.JD0, astr=astr, /ad2xy ; This might be broken! If it is, it's probably a problem with JDate
